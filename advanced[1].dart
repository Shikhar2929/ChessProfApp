...
class _AdvancedPageState extends State<AdvancedPage> {
  ...
  void _loadPrincipleList() async {
    CollectionReference collectionReference = await globals.firestore.collection('advancedprinciples');
    //Firestore.instance.collection('advancedprinciples');
  ...
  void _loadGameList() async {
    ...
    if (globals.firestore == null) {
      setState(() {
        gamedocs = null;
        gametitle = globals.initGamesTitle['advanced'];
        gamepgn = globals.initGamesMoves['advanced'];
        gamefen = '';
        gamecolor = 'white';
    ...
    CollectionReference collectionReference = await globals.firestore.collection('advancedgames');
    //Firestore.instance.collection('advancedgames');
