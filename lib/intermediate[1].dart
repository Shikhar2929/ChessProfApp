...
class IntermediatePage extends StatefulWidget {
  IntermediatePage(this.startGameId);
...
class _IntermediatePageState extends State<IntermediatePage> {
  ...
  void _loadPrincipleList() async {
    CollectionReference collectionReference = await globals.firestore.collection('intermediateprinciples');
    //Firestore.instance.collection('intermediateprinciples');
  ...
  void _loadGameList() async {
    ...
    if (globals.firestore == null) {
      setState(() {
        gamedocs = null;
        gametitle = globals.initGamesTitle['intermediate'];
        gamepgn = globals.initGamesMoves['intermediate'];
        gamefen = '';
        gamecolor = 'white';
    ...
    CollectionReference collectionReference = await globals.firestore.collection('intermediategames');
    //Firestore.instance.collection('intermediategames');
