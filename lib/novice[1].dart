...
class _NovicePageState extends State<NovicePage> {
  ...
  int _currGame = 1;
  String gameid;
  String gametitle = 'Practice Game';
  String gamepgn;
  String gamefen;
  String gamecolor;
  ...
  void _loadPrincipleList() async {
    CollectionReference collectionReference = await globals.firestore.collection('noviceprinciples');
    //Firestore.instance.collection('noviceprinciples');
  ...
  void _loadGameList() async {
    ...
    if (globals.firestore == null) {
      setState(() {
        gamedocs = null;
        gametitle = globals.initGamesTitle['novice'];
        gamepgn = globals.initGamesMoves['novice'];
        gamefen = '';
        gamecolor = 'white';
    ...
    CollectionReference collectionReference = await globals.firestore.collection('novicegames');
    //Firestore.instance.collection('novicegames');
