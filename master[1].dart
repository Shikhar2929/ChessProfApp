...
class _MasterPageState extends State<MasterPage> {
  ...
  void _loadPrincipleList() async {
    CollectionReference collectionReference = await globals.firestore.collection('masterprinciples');
    //Firestore.instance.collection('masterprinciples');
  ...
  void _loadGameList() async {
    ...
    if (globals.firestore == null) {
      setState(() {
        gamedocs = null;
        gametitle = globals.initGamesTitle['master'];
        gamepgn = globals.initGamesMoves['master'];
        gamefen = '';
        gamecolor = 'white';
    ...
    CollectionReference collectionReference = await globals.firestore.collection('mastergames');
    //Firestore.instance.collection('mastergames');
